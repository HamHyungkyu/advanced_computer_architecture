...
public:
    ...
    struct AddrMask {
      ...
      {"00000000.00000000.00000000.00000000.000000RR.RRRRRRRR.RRBBGCCC.CCCSSSSS"},
      {"00000000.00000000.00000000.00000000.00000RRR.RRRRRRRR.RBBGGCCC.CCCSSSSS"},
      {"00000000.00000000.00000000.00000000.0000RRRR.RRRRRRRR.RBBGGCCC.CCCSSSSS"},
      {"00000000.00000000.00000000.00000000.000RRRRR.RRRRRRRR.RBBGGCCC.CCCSSSSS"},
      {"00000000.00000000.00000000.00000000.00RRRRRR.RRRRRRRR.BBGGCCCC.CCCSSSSS"},
    }, addr_mask;
    ...
    {
        // GDDR5_4000 is baseline
        // Others are scaled from GDDR5_4000
        // we use GDDR5_5000 (1250MHz)
    ...
    // sungjun: it seems that the timings are based on SK Hynix H5GQ1H24AFR
    // (1GHz)
    // Other frequencies are scaled timings
    // WTRS == WTRL
    // RTPS == RTPL (delay for same bank) (no bank group level delay for RTP)
    // RRDS == RRDL
    struct SpeedEntry {
        int rate;
        double freq, tCK;
        ...
        int nRAS, nRC;
        int nPPD, nRTP, nWTR, nWTRL, nWR;
        int nRRD, nRRDL, nFAW, n32AW;
        int nRFC, nREFI;
        int nPD, nXPN, nLK;
        int nCKESR, nXS, nXSDLL;
    } speed_table[int(Speed::MAX)] = {
        {4000, 8*500/4,  8.0/8, 2, 2, 3, 12, 12, 10, 12, 3, 28, 40, 1, 2, 5, 5, 12, 6, 6, 23, 184, 0, 0, 10, 10, 0, 0, 0, 0},
        {4500, 9*500/4,  8.0/9, 2, 2, 3, 14, 14, 12, 14, 4, 32, 46, 2, 2, 6, 6, 14,  7, 7, 26, 207, 0, 0, 10, 10, 0, 0, 0, 0},
        {5000, 10*500/4, 8.0/10, 2, 2, 3, 15, 15, 13, 15, 4, 35, 50, 2, 2, 7, 7, 15,  7, 7, 29, 230, 0, 0, 10, 10, 0, 0, 0, 0},
        {5500, 11*500/4, 8.0/11, 2, 2, 3, 17, 17, 14, 17, 5, 39, 56, 2, 2, 7, 7, 17,  8, 8, 32, 253, 0, 0, 10, 10, 0, 0, 0, 0},
        {6000, 12*500/4, 8.0/12, 2, 2, 3, 18, 18, 15, 18, 5, 42, 60, 2, 2, 8, 8, 18,  9, 9, 35, 276, 0, 0, 10, 10, 0, 0, 0, 0},
        {6500, 13*500/4, 8.0/13, 2, 2, 3, 20, 20, 17, 20, 5, 46, 66, 2, 2, 9, 9, 20,  9, 9, 38, 299, 0, 0, 10, 10, 0, 0, 0, 0},
        {7000, 14*500/4, 8.0/14, 2, 2, 3, 21, 21, 18, 21, 6, 49, 70, 2, 2, 9, 9, 21, 10, 10, 41, 322, 0, 0, 10, 10, 0, 0, 0, 0},
        {7000, 14*500/4, 8.0/14, 2, 2, 2, 21, 21, 18, 21, 6, 49, 70, 2, 2, 9, 9, 21, 10, 10, 41, 322, 0, 0, 10, 10, 0, 0, 0, 0},
        {7000, 14*500/4, 8.0/14, 2, 2, 3, 21, 21, 18, 21, 6, 49, 70, 2, 2, 9, 9, 21, 10, 10, 41, 322, 0, 13650, 10, 10, 0, 0, 0, 0},
        {7000, 14*500/4, 8.0/14, 2, 2, 2, 21, 21, 18, 21, 6, 49, 70, 2, 2, 9, 9, 21, 10, 10, 41, 322, 0, 13650, 10, 10, 0, 0, 0, 0},
        {7000, 14*500/4, 8.0/14, 0, 1, 1, 21, 21, 18, 21, 6, 49, 70, 2, 2, 9, 9, 21, 10, 10, 41, 322, 0, 0, 10, 10, 0, 0, 0, 0},
    }, speed_entry;
